...
class demo01(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Demo01")
        ...
        self.settings = Qt.QSettings("GNU Radio", "demo01")
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self.blocks_vector_source_x_0 = blocks.vector_source_b((1, 0, 1, 1), True, 1, [])
        ...
        self.connect((self.blocks_char_to_float_0_0, 0), (self.blocks_multiply_xx_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate, 78000, 122000, 100, firdes.WIN_HANN, 6.76))
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 20000, 100, firdes.WIN_HAMMING, 6.76))
...
def main(top_block_cls=demo01, options=None):

...
class demo01_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "demo01_2")
        ...
        self.band_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.band_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self.analog_sig_source_x_4 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 500000, 1, 0, 0)
        self.analog_sig_source_x_3 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 300000, 1, 0, 0)
        self.analog_sig_source_x_2 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 300000, 1, 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 500000, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_3, 0), (self.blocks_multiply_xx_1, 1))
        self.connect((self.analog_sig_source_x_4, 0), (self.blocks_multiply_xx_1_0, 1))
        ...
        self.connect((self.low_pass_filter_0, 0), (self.blocks_sub_xx_1, 0))
        self.connect((self.low_pass_filter_0_0, 0), (self.blocks_sub_xx_1, 1))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate, 280000, 320000, 100, firdes.WIN_HAMMING, 6.76))
        self.band_pass_filter_1.set_taps(firdes.band_pass(1, self.samp_rate, 480000, 520000, 100, firdes.WIN_HAMMING, 6.76))
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 20000, 100, firdes.WIN_BLACKMAN, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate, 20000, 100, firdes.WIN_BLACKMAN, 6.76))
...
def main(top_block_cls=demo01_2, options=None):
